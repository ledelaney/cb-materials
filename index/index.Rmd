...
Find below the most up-to-date materials created for the UIC Biological Sciences Department online teaching efforts. If you need more assistance, consider joining the BIOS Teaching Slack workspace (see information on [Slack](http://ledelaney.org/cb-materials/slack/BIOS-Slack-Overview.html){target="_blank"} for more details), or email me at `ldelan5 at uic dot edu`. My **official working hours are Mon-Fri from 1p-5p**, but I am usually very responsive via email or Slack. 
