...
Under `Grading`, indicate the maximum points possible or select a rubric. (See the section on \textsc{Rubrics} for more detailed information on creating and using these tools.) 
