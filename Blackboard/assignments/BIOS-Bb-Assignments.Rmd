...
+ [ACCC quick-guide for Bb Assignment set-up](https://drive.google.com/file/d/1cQiVXKMnDQ45v8l3B8DP5kHIxH5iv7LI/view?usp=sharing)
+ [Bb help page for Assignments](https://help.blackboard.com/Learn/Instructor/Assignments/Create_and_Edit_Assignments)
+ [YouTube video on Bb Assignments](https://www.youtube.com/watch?v=hUXXCp1pnHs&feature=emb_logo&ab_channel=BlackboardInc.)
+ [YouTube video on creating Bb Rubrics](https://www.youtube.com/watch?v=VgKIkeo-t3Q&t=1s)

`r html.only('<a href="https://drive.google.com/file/d/1vyRbPHGFl5-1IOi6NAxauZpUyWI01bgF/view?usp=sharing" target="_blank">Click here to download PDF version of this document</a>')`

`r html.only("<span style = font-size:10px>Version 2: Compiled by L E Delaney for UIC Biological Sciences Department</span>")`
