---
title: "Adding People to Bb Courses"
subtitle: "UIC BioS"
author: "L E Delaney"
version: "Version 1"
output:
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/users-groups.png")`
3. Select the option `Find Users to Enroll`.
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/users-to-enroll.png")`
4. In the `Username` box, **type in the username** of the individual you wish to add. (The browse feature does not always work.) `r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/enroll-screen.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/show-all-users.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/enroll-screen.png")`
...
+ [KU resources for Users and Groups](https://blackboard.ku.edu/users-and-groups)

`r html.only("<br><br><br><span style = font-size:10px>Version 1: Compiled by L E Delaney for UIC Biological Sciences Department</span>")`
