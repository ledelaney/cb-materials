...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/package-util.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/destination-course.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/copy-options.png")`
7. In the `File Attachments` section, select `Copy links and copies of the content` 
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/file-attachments.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/tests-survey-pools.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/export-test.png")`
7. Select `Export`
    ...
    + If you choose `Export to Local Computer`, you can download the .zip file to your computer. `r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/export-local.png")`
...
6. Click `Import Test`. `r popups(mylink = "input/images/import-test.png")`
    + If you chose `Export to Content Collection`, select `Browse Content Collection` and look for the recently added `Test` file. `r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/browse-content.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/copy-move-item.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/move-destination.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/move-folder.png")`
7. Select `No` for the option `Create links for items which cannot be copied`.
8. Click `Submit`.

# More Resources

+ [KU resources for copying and moving content in Bb](https://blackboard.ku.edu/copying-course-content)
+ [YouTube video showing copying and moving content in Bb](https://www.youtube.com/watch?v=dO-IjSiiY1M&ab_channel=SDWTechnologyIntegrator) (looks slightly different but same procedure!)
