...
`r html.only('<a href="https://drive.google.com/file/d/1vANwUoU14woFlbLtmVYAhUbgsrnIDQM_/view?usp=sharing" target="_blank">Click here to download PDF version of this document</a>')`
...
[This document explains the general process](https://www.wbu.edu/wbu-online/documents/Uploading_Tests_in_Blackboard_using_Excel.pdf), but keep in mind you will still need to go back and check that each question imported properly.
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/remove-formatting.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/make-box.png")` 
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/make-border.png")` 
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/mc-options.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/copy-question.png")` 
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/categories.png")` 
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/question-settings.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/add-pool.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/ques-display.png")`
You can also edit the number of points that each question is worth.
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/ques-point.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/ques-order.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/ques-totals.png")`
...
[(More on how to create groups here.)](https://help.blackboard.com/Learn/Instructor/Interact/Course_Groups/Create_Groups)
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/test-exceptions.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/feedback-settings/only-score-per-question.png")`
2. `Show incorrect questions` will allow the students to see which questions they answered incorrectly. 
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/feedback-settings/score-per-question-and-incorrect.png")`
3. `All answers` shows all of the possible answers students could have selected (i.e., all answer choices). 
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/feedback-settings/scoreper-incorrect-allanswers.png")`
4. `Correct` shows correct answers for each of the questions. 
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/feedback-settings/scoreper-incorrect-allanswers-correct.png")`
5. `Submitted` shows only the answer that the student selected or submitted. 
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/feedback-settings/everythingchecked.png")`
...
`r html.only("<span style = font-size:10px>Version 5: Compiled by L E Delaney for UIC Biological Sciences Department</span>")`
