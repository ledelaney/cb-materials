...
`r html.only('<a href="https://drive.google.com/file/d/1vyRbPHGFl5-1IOi6NAxauZpUyWI01bgF/view?usp=sharing" target="_blank">Click here to download PDF version of this document</a>')`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/edit-slack-profile.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/slack-notifications.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/slack-channels.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/slack-mute-channel.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/slack-thread.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/slack-emoji.png")`
3. If you want to ensure a specific person sees your post, use the `@` symbol to tag that individual in your post or reply.
`r popups(mylink = "http://ledelaney.org/cb-tutorials/blackboard/input/images/slack-at.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/slack-edit-message.png")`s
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/slack/input/images/slack-file-browse.png")`
...
Check out the [associated Slack Overview video](https://drive.google.com/file/d/1otltPSIP3Brabtu88iupECe6bDBB-3zW/view?usp=sharing) to see demonstrations of these concepts in action. 
