...
`r html.only('<a href="https://drive.google.com/file/d/1LWHZB7ih3rSfW_l29KgtoEpxxtyeG13_/view?usp=sharing" target="_blank">Click here to download PDF version of this document</a>')`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/edit-slack-profile.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/slack-notifications.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/slack-channels.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/slack-mute-channel.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/slack-thread.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/slack-emoji.png")`
3. If you want to ensure a specific person sees your post, use the `@` symbol to tag that individual in your post or reply.
`r popups(mylink = "http://ledelaney.org/cb-materials/blackboard/input/images/slack-at.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/slack-edit-message.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-materials/slack/input/images/slack-file-browse.png")`
...
+ [Video tour of Slack](https://drive.google.com/file/d/1otltPSIP3Brabtu88iupECe6bDBB-3zW/view?usp=sharing)
+ [Slack for beginners YouTube Video](https://www.youtube.com/watch?v=7YUTc4Cigc8&ab_channel=Howfinity)
+ [Slack tutorial webpage](https://slack.com/resources/using-slack/how-to-use-slack)
