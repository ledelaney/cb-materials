...
For information on setting up Panopto in Blackboard and general use, see the [Panopto Overview document](https://ledelaney.org/cb-materials/panopto/BIOS-Panopto-Overciew.html){target="_blank"}.
...
`r popups("https://ledelaney.org/cb-materials/panopto/input/images/add-panopto.png")`
...
Fill out the other details of your assignment as normal. For more information on creating Blackboard assignments, [click here](https://ledelaney.org/cb-materials/blackboard/BIOS-Bb-Assignments.html){target="_blank"}.
...
`r popups("https://ledelaney.org/cb-materials/panopto/input/images/feedback-sub.png")`
Click submit.
...
+ [Comprehensive Panopto video overview](https://ledelaney.org/cb-materials/panopto/BIOS-Panopto-Overciew.html){target="_blank"}
