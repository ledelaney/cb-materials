...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/panopto/input/images/add-toollink.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/panopto/input/images/panopto-video-settings.png")`
