...
+ [Adding users to Bb courses](http://ledelaney.org/cb-materials/blackboard/BIOS-Bb-AddMe.html)

## Zoom for Synchronous Teaching

+ [Brief guide to Zoom in Bb](http://ledelaney.org/cb-materials/zoom/BIOS-Zoom-SynchLecture.html)

## Panopto for Asynchronous Teaching

+ [Brief guide to Panopto in Bb](http://ledelaney.org/cb-materials/panopto/BIOS-Panopto-Overview.html)

## Slack

+ [Brief guide to using Slack](http://ledelaney.org/cb-materials/slack/BIOS-Slack-Overview.html)
