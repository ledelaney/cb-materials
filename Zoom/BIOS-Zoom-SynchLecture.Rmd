...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/zoom/input/images/add-toollink.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/zoom/input/images/zoom-start-meeting.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/zoom/input/images/zoom-edit.png")`
Scroll to the bottom of the screen and select `Download a CSV Template`.
`r popups(mylink = "http://ledelaney.org/cb-tutorials/zoom/input/images/zoom-poll-csv.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/zoom/input/images/zoom-poll.png")`
...
`r popups(mylink = "http://ledelaney.org/cb-tutorials/zoom/input/images/zoom-emoji.png")`
...
(I use the free version of this app.)
